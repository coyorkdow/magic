...
template <class T>
struct IsIterable<
    T, typename std::enable_if<std::is_same<typename detail::BeginType<T>::type, typename detail::EndType<T>::type>{},
                               void>::type> : public std::true_type {};

template <class T, class... Args>
struct IsConstructible
    : public std::integral_constant<bool, decltype(detail::IsConstructibleImpl<T, Args...>(0))::value> {};
